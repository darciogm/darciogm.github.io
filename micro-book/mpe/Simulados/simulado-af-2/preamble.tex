...
% compactação prova-only (teto de 12 páginas; solução fica confortável)
\ifsolucao\else
  \linespread{1.0}
  \setlength{\parskip}{0.28em}
\fi

% título de bloco enxuto (substitui \section*, que gasta ~2em de skips)
\newcommand{\blocotitulo}[1]{\par\vspace{0.8em}\noindent{\Large\bfseries #1}\par\nopagebreak\vspace{0.35em}}

% ---------- header/footer ----------
\pagestyle{fancy}
\fancyhf{}
\lhead{Microeconomia I --- MPE}
\chead{\ifsolucao Simulado 2 AF --- Solução e Rubrica\else Simulado 2 --- Avaliação Final\fi}
