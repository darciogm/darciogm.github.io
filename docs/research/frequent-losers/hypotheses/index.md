...
| [H3](exposure-discipline.md) | Genuine signal survives once opportunity is netted out. | Most raw concentration is mechanical exposure (label-blind opportunity ≈ 0.553; ranking by observed contact 0.90 is mechanical label encoding); within-stratum AUC is at chance (0.471), nested increment +0.010 (DeLong p = 0.013) but matched permutation p = 0.127 (ns) and FL-enrichment p = 0.067 (ns); negative controls corroborate the opportunity account (real ≈ placebo p = 0.46); armor battery confirms (positive control 0.953; permutation power 0.97 @ within-AUC 0.55). **No robust residual** survives the discipline. | [AN-005](../analyses/an-005-sham-fl-permutation.md), [AN-014](../analyses/an-014-leakage-audit-d3.md), [AN-027](../analyses/an-027-universe-anchored-stratum-scope.md), [AN-028](../analyses/an-028-exposure-stratum-balance.md) | **Not confirmed (opportunity explains it)** |
