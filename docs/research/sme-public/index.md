...
!!! danger "Costs concentrated in high-value items"
    The price effect is **40% larger for high-value items** (above median), where the pool of capable non-SME suppliers is broader.

!!! info "Local suppliers benefit from the policy"
    Before the policy change, winning firms for group 65 were **~4 km more distant** from PBUs, suggesting that SME-only tenders successfully encouraged local supplier participation.
