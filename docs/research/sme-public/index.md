...
!!! warning "Endogenous SME entry attenuates a 45--93% larger latent shock"
    Holding the SME pool at its pre-policy size raises the simulated price effect to **145% of the realized one in non-pharma** and 193% in pharma. Without endogenous entry, the set-aside would cost 45--93% more in price and welfare. Participation is the government's partial offset, not the source of the markup.
