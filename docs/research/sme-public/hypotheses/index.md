...
| [H7](ipv-clock-admissible.md) | Pregão drop-outs admit IPV-clock interpretation | English clock + private values + truthful exit pin down willingness-to-supply | [AN-013](../analyses/an-013-pregao-dropouts.md) drop-out extraction; [AN-014](../analyses/an-014-uh-correction.md) Krasnokutskaya-style heterogeneity correction; [AN-015](../analyses/an-015-collusion-screens.md) Bajari-Ye / Schurter screens | **Not yet tested** |
...
| [H11](parallel-trends-hold.md) | Placebo nulls + HonestDiD survives M̄ violations + Lee bounds tight | DiDiR-in-reverse exploits the 2018 PGE-SP legal reversal | [AN-004](../analyses/an-004-placebo-tests.md) price placebo null; [AN-005](../analyses/an-005-lee-bounds.md) bounds &minus;0.131 to &minus;0.123; [AN-006](../analyses/an-006-honestdid.md) survives substantial M̄; [AN-018](../analyses/an-018-cs2021-staggered.md) Callaway-Sant'Anna and Sun-Abraham confirm | **Partial (toward Supports)** |
| [H12](no-collusion-confound.md) | The price drop is not a collusion shift | If bidder coordination loosened post-2018, drop-outs lose the IPV interpretation | [AN-015](../analyses/an-015-collusion-screens.md) Bajari-Ye, Schurter, pair-classification screens; load-bearing for IPV reading | **Not yet tested** |
