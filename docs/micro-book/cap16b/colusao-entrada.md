...
A [Tabela 16b.1](#tabela-16b-1) lista os principais fatores que facilitam a sustentação de acordos colusivos.
...
**Tabela 16b.1 — Fatores que facilitam a colusão.**
</div>
...
!!! box-mundo "Box Mundo — Colusão algorítmica: quando a IA aprende a fazer cartel"
...
## 16b.2 Redesenhando o Tabuleiro: Investimento, Entrada e Saída {#16b2}
...
## 16b.3 Fábrica Grande Antes do Rival Chegar: Dissuasão de Entrada {#16b3}
...
## 16b.4 Mostrar para Não Precisar Provar: Sinalização {#16b4}
