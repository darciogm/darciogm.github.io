...
- Casos aplicados ao Brasil (IBGE, IPEA, BCB)
...
<a href="cap01/" class="hub-card hub-card--fund">
  <div class="hub-card__label">Parte I</div>
  <div class="hub-card__title">Introdução</div>
  <div class="hub-card__desc">Modelos econômicos e ferramentas matemáticas</div>
  <div class="hub-card__caps">Caps. 1–2</div>
</a>

<a href="cap03/" class="hub-card hub-card--fund">
  <div class="hub-card__label">Parte II</div>
  <div class="hub-card__title">Escolha e Demanda</div>
  <div class="hub-card__desc">Preferências, utilidade, efeitos renda e substituição</div>
