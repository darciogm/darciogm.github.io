...
## 16.14 Muitos Restaurantes, Nenhum Igual: Competição Monopolística {#1614}
...
A competição monopolística é empiricamente relevante para muitos mercados: restaurantes, varejo de vestuário, cabeleireiros, aplicativos de celular, livros. A diferenciação é horizontal (gostos diferentes) mais do que vertical (qualidade diferente), conectando-se diretamente ao modelo de Hotelling da [Seção 16.6](capacidade-diferenciacao.md#166).
...
## 16.15 Quando Dois Viram Um: Fusões e Política Antitruste {#1615}
...
## 16.16 O Juiz na Mesa de Pôquer: Regulação de Oligopólios {#1616}
