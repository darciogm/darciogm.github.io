...
## 16.1 Preço ou Quantidade — Eis a Questão: Decisões de Curto Prazo {#161}
...
## 16.2 Dois Bastam para a Guerra: Modelo de Bertrand {#162}
...
1. **Diferenciação de produto**: se os bens não são substitutos perfeitos, as firmas retêm algum poder de mercado mesmo cobrando preços diferentes ([Seção 16.6](capacidade-diferenciacao.md#166)).
2. **Restrições de capacidade**: se as firmas têm capacidade limitada, a firma de preço mais baixo não pode atender toda a demanda ([Seção 16.5](capacidade-diferenciacao.md#165)).
3. **Interação repetida**: em jogos repetidos, a ameaça de retaliação futura pode sustentar preços acima do custo ([Seção 16.7](colusao-entrada.md#167)).
...
## 16.3 Quanto Produzir Quando o Rival Pensa o Mesmo: Modelo de Cournot {#163}
...
## 16.4 De Monopólio a Concorrência em n Passos: Cournot com n Firmas {#164}
