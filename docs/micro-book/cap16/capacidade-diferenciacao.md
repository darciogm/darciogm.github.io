# 16.5–16.6 Capacidade e Diferenciação

## 16.5 Não Dá para Atender Todo Mundo: Restrições de Capacidade {#165}
...
## 16.6 Nem Todo Café É Igual: Diferenciação de Produto {#166}
