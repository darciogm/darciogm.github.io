...
!!! abstract "Roteiro do capítulo"
    ...
    |:---:|---|---|:---:|
    | **6.1–6.4** | Quais as relações cruzadas entre bens? | Efeitos cruzados, substitutos/complementos brutos e líquidos, matriz de Slutsky | [Relações](relacoes.md) |
    | **6.5–6.6** | Como simplificar uma economia com milhares de bens? | Teorema do Bem Composto, modelo de Lancaster, preços hedônicos, Becker | [Bem Composto e Lancaster](composto.md) |
    | **6.7–6.8** | A demanda de mercado herda as propriedades individuais? | Agregação, condição de Gorman, classificação de pares brasileiros | [Agregação](agregacao.md) |
    | **Exercícios** | Teste e aplique | Revisão, exercícios, ANPEC | [Exercícios](exercicios.md) |
    | **Pesquisa** | O que a fronteira diz? | AIDS, BLP, Rosen, Lewbel, Dubois et al. | [Pesquisa](pesquisa.md) |
