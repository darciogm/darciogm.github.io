...
|:---:|---|---|:---:|
| 9d.1 | Como exigir crenças que fazem sentido num jogo sequencial com tipos ocultos? | PBE: otimalidade sequencial + consistência bayesiana; refinamentos (Cho-Kreps) | [PBE](pbe.md) |
| 9d.2 | O MBA ensina algo — ou apenas sinaliza? | Modelo de Spence, single-crossing, equilíbrio separador vs. pooling, inflação de diplomas | [Sinalização](sinalizacao.md) |
