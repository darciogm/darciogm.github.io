...
<a id="questao-anpec-22-1"></a>**Questão 1.** Classifique as afirmações como **Verdadeiro (V)** ou **Falso (F)**:
...
<a id="questao-anpec-22-2"></a>**Questão 2.** Classifique as afirmações como **Verdadeiro (V)** ou **Falso (F)**:
