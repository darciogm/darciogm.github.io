...
??? example "✏️ Exercício Resolvido 1.1 — Análise positiva versus normativa"
...
??? example "✏️ Exercício Resolvido 1.2 — Variáveis exógenas, endógenas e estática comparativa"
...
??? example "✏️ Exercício Resolvido 1.3 — Maximização de lucro e a condição \(P = CMg\)"
