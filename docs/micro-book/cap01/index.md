...
Este capítulo apresenta a lógica da construção de modelos em economia, discute como verificá-los empiricamente, examina suas características fundamentais e traça um panorama histórico do desenvolvimento da teoria do valor — o problema central da microeconomia.[^cap1-fontes] Ao final, você estará preparado para mergulhar nas ferramentas matemáticas do Capítulo 2 e, em seguida, na teoria do consumidor (Capítulos 3 e 4), que traduz as ideias aqui apresentadas em modelos formais de escolha individual.

[^cap1-fontes]: A exposição segue Nicholson e Snyder (2017, Cap. 1), complementada por Mas-Colell, Whinston e Green (1995, Cap. 1) e Varian (2015, Cap. 1). Para uma discussão acessível e rica em aplicações, ver Pindyck e Rubinfeld (2013, Caps. 1–2).

!!! abstract "Roteiro do capítulo"

    <div class="chapter-roadmap" markdown>

    | Seção | Pergunta-guia | O que você vai aprender |
    |:---:|---|---|
    | **1.1** | Por que simplificar? | A lógica dos modelos: omitir para revelar |
    | **1.2** | Como saber se a mentira é boa? | Verificação direta vs. indireta; correlação ≠ causalidade |
    | **1.3** | Quais são as regras do jogo? | Os três pilares: *ceteris paribus*, otimização, positivo vs. normativo |
    | **1.4** | Como um modelo se materializa? | Variáveis exógenas/endógenas, equilíbrio, estática comparativa |
    | **1.5** | De onde vieram essas ideias? | Do paradoxo da água e do diamante à síntese de Marshall |
    | **1.6** | Para onde a micro está indo? | Jogos, informação, comportamento, mecanismos |
    | **1.7** | Como isso funciona na prática? | Demonstração completa: por que \(P = CMg\) |
...
!!! atividade "Atividade — Antes de ler, pense (2 min)"
    ...
    1. O que você escolhe em cada situação?
    2. O que mudou entre A e B? A água? O diamante? Ou outra coisa?
    3. *Discuta com um colega* (ou anote sua resposta) antes de continuar lendo. Você vai reencontrar essa questão — resolvida — em algumas páginas.
...
Se você fez a atividade acima, provavelmente intuiu a resposta: não é a água nem o diamante que muda entre o deserto e o shopping — é o **contexto**, a **escassez relativa**. No deserto, o próximo litro de água é questão de vida ou morte; no shopping, é supérfluo. O diamante, por sua vez, é sempre escasso. Essa intuição — de que o valor depende da *circunstância*, não da *essência* do bem — levou séculos para ser formalizada. A história de como isso aconteceu é uma das mais fascinantes da ciência.
...
| 1867 | Karl Marx | Teoria do valor-trabalho levada ao limite; mais-valia; crítica à economia política |
| 1871 | Revolução Marginalista (Jevons, Menger, Walras) | Valor determinado pela utilidade marginal; análise na margem |
| 1881 | Francis Edgeworth | Caixa de Edgeworth; curvas de indiferença; teoria da barganha |
| 1890 | Alfred Marshall | Síntese neoclássica: oferta e demanda como "duas lâminas da tesoura" |
| 1906 | Vilfredo Pareto | Eficiência de Pareto; curvas de indiferença como ferramenta ordinal |
| 1939 | John Hicks | *Value and Capital*: formalização da teoria do consumidor e equilíbrio geral |
| 1944 | von Neumann & Morgenstern | *Theory of Games*: fundação da teoria dos jogos |
| 1947 | Paul Samuelson | *Foundations*: axiomatização da teoria econômica; preferência revelada |
| 1950 | John Nash | Equilíbrio de Nash: solução para jogos não cooperativos |
| 1954 | Arrow & Debreu | Prova de existência do equilíbrio geral competitivo |
| 1970 | George Akerlof | "Mercado de limões": seleção adversa e informação assimétrica |
| 1973 | Michael Spence | Sinalização no mercado de trabalho |
| 1979 | Kahneman & Tversky | Teoria da perspectiva: vieses cognitivos e decisão sob risco |
| 2000– | Economia de plataformas, design de mercados, inferência causal | Fronteiras contemporâneas da microeconomia |
...
- **Teoria dos jogos**: modelagem de interações estratégicas entre agentes, quando as decisões de cada um afetam os resultados dos demais (Nash, 1950; Mas-Colell et al., 1995, parte IV). Quando a Ambev decide o preço de sua cerveja, ela considera a possível reação da Heineken — e vice-versa. Essa interdependência estratégica, ausente no modelo competitivo, é o objeto da teoria dos jogos, que será tema do Capítulo 9, com aplicações a mercados oligopolistas nos Capítulos 15–16.
- **Economia da informação**: quando você abre o Tinder, sabe menos sobre a pessoa do que ela sabe sobre si mesma — isso é informação assimétrica. A análise de mercados com esse tipo de desbalanceamento informacional — seleção adversa (Akerlof, 1970), risco moral (Arrow, 1963; Holmström, 1979) e sinalização (Spence, 1973) — é um dos pilares da microeconomia moderna. No mercado de carros usados, por exemplo, o vendedor sabe mais sobre a qualidade do veículo do que o comprador, o que pode levar ao colapso do mercado para carros de boa qualidade — o famoso "mercado de limões" de Akerlof.
- **Economia comportamental**: se você já comprou algo na Black Friday que não precisava, parabéns: você é um dado empírico da economia comportamental. Essa área incorpora insights da psicologia — racionalidade limitada, vieses cognitivos, preferências dependentes de referência (Kahneman & Tversky, 1979). No Brasil, princípios comportamentais vêm sendo aplicados em políticas públicas, como o uso de *nudges* (arquitetura de escolhas) na simplificação de formulários de acesso a benefícios sociais e na comunicação sobre educação financeira pelo Banco Central.
...
- **Economia de plataformas**: mercados de dois lados (*two-sided markets*) como iFood, Uber e Mercado Livre, onde a plataforma precisa atrair simultaneamente dois grupos de usuários — uma estrutura analisada por Rochet e Tirole (2003) que desafia os modelos tradicionais de precificação. Tirole recebeu o Nobel em 2014 por suas contribuições à economia de mercados com poder de mercado e regulação.
...
!!! box-mundo "Box Mundo 1.2 — O Consenso de Washington: quando modelos moldam (e falham em) políticas"

    Em 1989, John Williamson cunhou o termo "Consenso de Washington" para descrever dez recomendações de política — disciplina fiscal, liberalização comercial, privatizações, desregulamentação — que FMI, Banco Mundial e Tesouro dos EUA consideravam necessárias para países em desenvolvimento. A lógica derivava diretamente do Primeiro Teorema do Bem-Estar: se mercados competitivos são eficientes, remover distorções governamentais deveria melhorar a alocação.

    **Os resultados foram heterogêneos.** Implementadas em mais de 70 países, as reformas de ajuste estrutural produziram, segundo Easterly (2005), crescimento per capita mediano de apenas 0,1% ao ano na África (1980–1999). Na América Latina, a inflação foi domada (no Brasil, de 2.477% para menos de 10% após o Plano Real), mas desigualdade e desemprego aumentaram em vários países.

    **A lição metodológica é profunda.** Rodrik (2006) argumentou que o fracasso parcial não invalidou a teoria, mas revelou que os modelos que fundamentavam as recomendações pressupunham mercados completos, informação perfeita e instituições eficientes — hipóteses que raramente se verificavam nos países-alvo. A "tradução" de modelos abstratos em políticas concretas exige atenção às condições locais — exatamente a distinção entre pressupostos e realidade discutida na Seção 1.1. Como veremos no estudo do equilíbrio geral e do bem-estar (Capítulos 14 e 17), o Primeiro Teorema tem hipóteses precisas, e ignorá-las tem consequências reais.

    **Fonte:** Williamson (1990), *Latin American Adjustment*. Easterly (2005), *J. Development Economics*, 76(1), 1–22. Rodrik (2006), *J. Economic Literature*, 44(4), 973–987.
...
!!! box-mundo "Box Mundo 1.3 — A revolução da credibilidade: experimentos naturais e o Nobel de 2021"
    ...
    **Fonte:** Angrist, J. D.; Krueger, A. B. (1991). Does compulsory school attendance affect schooling and earnings? *Quarterly Journal of Economics*, 106(4), 979–1014. Imbens, G. W.; Angrist, J. D. (1994). Identification and estimation of local average treatment effects. *Econometrica*, 62(2), 467–475. Nobel Prize Committee (2021). *Scientific Background: Answering Causal Questions Using Observational Data*. Royal Swedish Academy of Sciences.
...
- Keynes, John Neville. 1891. [*The Scope and Method of Political Economy*](https://archive.org/details/scopeandmethodo00telerich). London: Macmillan.
