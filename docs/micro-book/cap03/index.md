...
!!! abstract "Roteiro do capítulo"
    ...
    | Seção | Conceito | Para que serve | Onde reaparece |
    |:---:|---|---|---|
    | **3.1** | Axiomas da escolha racional | O alicerce: completude, transitividade, continuidade, monotonicidade | Todo o livro |
    | **3.2** | Função de utilidade (Debreu) | Traduzir preferências em números — da linguagem verbal à analítica | Caps. 4–6 |
    | **3.3** | Curvas de indiferença | O "mapa topográfico" das preferências | Caps. 4–5 |
    | **3.4** | Taxa marginal de substituição (TMS) | O "preço pessoal" de trocar um bem por outro | Caps. 4–5, 12 |
    | **3.5** | Utilidade marginal e TMS | TMS = UMg₁/UMg₂ — a ponte entre geometria e cálculo | Cap. 4 |
    | **3.6** | Formas funcionais | Cobb-Douglas, CES, Leontief, substitutos, quase-linear, homotéticas | Todo o livro |
    | **3.7** | Transformações monotônicas | A liberdade ordinal: trocar a "régua" sem alterar as preferências | Caps. 4–5 |
